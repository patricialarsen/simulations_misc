...
srun -n 32 --cpu-bind=cores -c16 ./hydro_xray /pscratch/sd/p/plarsen/HACC_LC/600/m000p.lc.mpicosmo.  /pscratch/sd/p/plarsen/HACC_LC/600/lc_hydro_tot 4096 2 600 0.6766 1.0 600 25
